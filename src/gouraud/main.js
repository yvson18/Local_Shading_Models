...
//fov := Ângulo de abertura da câmera 
//aspecto := largura / altura
//near := near plane
//far := far plane

//fov , aspecto, near, far
let camera = new THREE.PerspectiveCamera(75, window.innerWidth / window.innerHeight, 0.1, 1000); // gera a matriz de projeção no OPENGL
camera.position.z = 25; // cria a matriz view
...
renderer.setSize(window.innerWidth, window.innerHeight); // gera a viewport
